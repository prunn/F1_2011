package com.prunn.rfdynhud.widgets.prunn.f1_2011.persosectors;
...
{
    private DrawnString dsSec1 = null;
    private DrawnString dsSec2 = null;
    private DrawnString dsSec3 = null;
    ...
    private final ImagePropertyWithTexture imgSector = new ImagePropertyWithTexture( "imgSector", "prunn/f1_2011/timer/timer_bg.png" );
    private final ImagePropertyWithTexture imgPersonalBest = new ImagePropertyWithTexture( "imgPersonalBest", "prunn/f1_2011/timer/personal_best.png" );
    private final ImagePropertyWithTexture imgFast = new ImagePropertyWithTexture( "imgFast", "prunn/f1_2011/timer/timer_green.png" );
    private final ImagePropertyWithTexture imgSlow = new ImagePropertyWithTexture( "imgSlow", "prunn/f1_2011/timer/timer_yellow.png" );
    private final ImagePropertyWithTexture imgLap = new ImagePropertyWithTexture( "imgSector", "prunn/f1_2011/data_neutral.png" );
    private final ImagePropertyWithTexture imgLapPersoBest = new ImagePropertyWithTexture( "imgLapPersoBest", "prunn/f1_2011/data_faster.png" );
    private final ImagePropertyWithTexture imgLapFast = new ImagePropertyWithTexture( "imgFast", "prunn/f1_2011/data_fastest.png" );
    private final ImagePropertyWithTexture imgLapSlow = new ImagePropertyWithTexture( "imgSlow", "prunn/f1_2011/data_slower.png" );
    ...
    protected void initialize( LiveGameData gameData, boolean isEditorMode, DrawnStringFactory drawnStringFactory, TextureImage2D texture, int width, int height )
    {
        ...
        dsSec1 = drawnStringFactory.newDrawnString( "dsSec1", w1, top1 + fontyoffset.getValue(), Alignment.CENTER, false, f1_2011Font.getFont(), isFontAntiAliased(), whiteFontColor);
        dsSec2 = drawnStringFactory.newDrawnString( "dsSec2", w1, top2 + fontyoffset.getValue(), Alignment.CENTER, false, f1_2011Font.getFont(), isFontAntiAliased(), whiteFontColor);
        dsSec3 = drawnStringFactory.newDrawnString( "dsSec3", w1, top3 + fontyoffset.getValue(), Alignment.CENTER, false, f1_2011Font.getFont(), isFontAntiAliased(), whiteFontColor);
    ...
    {
        super( PrunnWidgetSetf1_2011.INSTANCE, PrunnWidgetSetf1_2011.WIDGET_PACKAGE_F1_2011, 13.0f, 14.1f );
